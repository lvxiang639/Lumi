...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .dancing .skirt-group {
    animation: danceSkirt 0.4s ease-in-out infinite;
  }
  .dancing .arm-l, .dancing .arm-r {
    animation: danceArm 0.55s ease-in-out infinite;
  }
  @keyframes danceBody {
...
<script>
  ...
  const mouthGrp = document.getElementById('mouthGroup');
  ...
  function scheduleBlink() {
    ...
    blinkTimer = setTimeout(() => {
      ...
      setTimeout(() => char.classList.remove('blinking'), 150);
      scheduleBlink();
    }, delay);
  }
  scheduleBlink();
