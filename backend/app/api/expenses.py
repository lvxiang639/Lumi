...
from app.domain.expense import ExpenseService
...
async def get_weekly_insights(
    ...
    """Generate a weekly insight report — delegated to ExpenseService."""
    return await ExpenseService.get_weekly_insights(current_user.id, db, llm_router)
