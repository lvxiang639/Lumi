...
async def list_knowledge(
    ...
    return {"items": [{"id": str(k.id), "title": k.title, "file_name": k.file_name, "chunk_count": k.chunk_count, "created_at": k.created_at.isoformat() if k.created_at else ""} for k in items]}
